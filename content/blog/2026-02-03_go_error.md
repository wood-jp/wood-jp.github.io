...
{{< alert "tip" >}}
**Bonus for Go 1.26:** Extract can be simplified using [errors.AsType](https://antonz.org/go-1-26/#errors-astype):
...
The complete code for our generic error wrapper can be found at [github.com/wood-jp/xerrors](https://github.com/wood-jp/xerrors). It contains tests, and is ready for use in production if you wish. Note that the code will likely differ from what was presented here as it is expanded and improved over time.

In my next article in this series, I'll provide some concrete use cases for our generic error wrapper, which I hope will make the value of this wrapper much more clear.

### Related Reading

No one writes code in a vaccuum. Here are some helpful resourced that helped me with writing this article:
...
*Some code in this article is based on work from [zkr-go-common](https://github.com/zircuit-labs/zkr-go-common-public), licensed under the MIT License.*
