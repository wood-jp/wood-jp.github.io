...
I have always been a backend developer, so don't expect much front-end stuff from me. My primary language for many years now has been Go, but I've worked in C, C++, Java, Python, Bash, and probably a bunch of others at some point or another. I've even been trying to learn Rust recently, so that could come up too. However, as I said, I don't want this blog to be just about writing code. I also want to touch on process, roles, hiring, tools, and all the other fun stuff that comes with the real world of software development.
