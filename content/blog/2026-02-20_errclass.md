...
The complete code for our errclass package can be found on [github](https://github.com/wood-jp/xerrors/tree/main/errclass). Note that the code will likely differ from what was presented here as it is expanded and improved over time.
